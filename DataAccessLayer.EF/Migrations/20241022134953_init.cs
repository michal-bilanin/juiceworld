    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "I am a steroid user!", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "user@example.com", "yzilxAAz88HDPdYEgsbhL6xmQdgaBflAEed49iMxlNo=", 10, "GRI7kQSiuEwYfctvvtxLjA==", null, "user", "Customer" },
                    { 2, "I am a steroid Admin!", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "admin@example.com", "BhDXzRRljN8yxkqEcMq6D4V97qI5GK3VMijCHCAFrOk=", 10, "JZUQbmOPJZvvHsmHqLYLyA==", null, "admin", "Admin" }
                });
